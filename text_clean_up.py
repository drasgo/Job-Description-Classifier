...
def clean_text(text: str, stemmer=None, lemmatizer=None) -> str:
    if stemmer is None:
        stemmer = snowball.ItalianStemmer()
...
def encode_vector_testing(elements, tokens, max_length) -> list:
    encoded = []
